...
def retrieve_manifest_files(key: str, s3, schema, **kw) -> SimpleNamespace:
    """
...
def list_inventory(manifest, s3=None, prefix: str = '', suffix: str = '', contains: str = '', **kw) -> SimpleNamespace:
    """
