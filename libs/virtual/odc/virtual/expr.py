...
class FormulaEvaluator(lark.Transformer):
    from operator import not_, or_, and_, xor  # type: ignore[misc] # pylint: disable=C0415
    from operator import eq, ne, le, ge, lt, gt  # type: ignore[misc] # pylint: disable=C0415
    from operator import add, sub, mul, truediv, floordiv  # type: ignore[misc] # pylint: disable=C0415
    from operator import neg, pos, inv  # type: ignore[misc] # pylint: disable=C0415
    from operator import mod, pow, lshift, rshift  # type: ignore[misc] # pylint: disable=C0415
...
class MaskEvaluator(lark.Transformer):
    ...
    from operator import or_  # type: ignore[misc] # pylint: disable=C0415
